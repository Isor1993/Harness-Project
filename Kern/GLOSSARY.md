...
| **Stack-Entscheidung** | Die Festlegung vom 2026-09-07: Unreal Engine + C++ als ein Stack für Studium, Isor's Tower und Beruf — mit Kontrollpunkt an der Prototyp-Phase (Ende Nov. 2026) und dokumentiertem Rückweg. | `Uni/DECISIONS.md`, „2026-09-07 — Engine- und Sprachfokus" |
| **Frontloading** | Grundsatz der Semester-3-Roadmap: Jede Abgabe soll vor dem geschätzten Termin und vor dem zugehörigen Unterricht fertig sein; verplant werden 24 Stunden je Woche, der Überschuss ist Crunch-Reserve. | `Uni/DECISIONS.md`, „2026-09-08 — Semester-3-Roadmap: Frontloading mit 24-Stunden-Wochen" |
...
| **Zustandsautomat** | Das Programm-Gerüst des Lane Defender: ein enum-Zustand plus Schleife in `main` rufen je Zustand die passende Szenen-Funktion auf; Szenenwechsel heißt Zustand umstellen. | `Projekte/Lane_Defender/DECISIONS.md`, „M1-Ablauf: Szenen-Zustandsautomat mit sechs Stationen" |
