...
# UnicodeEncodeError ab, sobald ein Fund ein Zeichen ausserhalb cp1252
# enthaelt — der Fund selbst geht dabei verloren. Ein Pruefwerkzeug darf an
# seinem eigenen Ergebnis nicht scheitern. (Ausgeloest am 2026-08-23 vom
# Pfeil in der Glossar-Meldung.)
...
# Programmordner, kein Bestand — ohne diese Zeile zaehlte das Skript die
# fuenf Arbeitskopien der Befehle als Harness-Dokumente mit.
...
def md_dateien():
    """Alle .md des Harness, relativ zur Wurzel, ohne Werkzeuge und Befehle."""
    treffer = []
...
def finde(name):
    """Alle Dateien dieses Namens im Bestand. Bis 1.0.0 suchte diese
    Funktion zwei Ebenen nach oben mit, weil es `CLAUDE.md` dreimal gab —
    Notkern, Wegweiser, Regeldatei. Seit 2.0.0 ist die Wurzel des Repos der
    Harness selbst; es gibt genau eine, und der Griff nach oben ginge ins
    Leere."""
